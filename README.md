...
1. **Backend Service**
   ...
   - Add env vars: `MONGODB_URI`, `JWT_SECRET`, `PORT`
2. **Frontend Service**
...
After deploy, ensure frontend calls backend public Railway URL.
...
## Extra Files For Submission Help

- `DEMO_SCRIPT.md` - ready speaking flow for your 2-5 min video
- `TEST_CHECKLIST.md` - manual QA checklist before final submit
